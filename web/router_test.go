...
func TestStaticRouteFound(t *testing.T) {
	...
	n, ok := r.findHandler(http.MethodGet, "/")
	...
	n, ok = r.findHandler(http.MethodGet, "/user")
	...
	n, ok = r.findHandler(http.MethodGet, "/admin/login")
	...
	n, ok = r.findHandler(http.MethodGet, "/user/login")
	...
	n, ok = r.findHandler(http.MethodGet, "/user/logout")
...
func TestWildcardRouteFound(t *testing.T) {
	...
	n, ok := r.findHandler(http.MethodGet, "/user/a")
